...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include '/../Modelo/Profesor.php'; // Ruta correcta al archivo Profesor.php
    $modelo = new Profesor(); // Crear una instancia de la clase Profesor
    ...
    if ($cedula && $nombre && $apellido && $email && $telefono && $usuario && $clave) {
        ...
        $guardado = $modelo->crearProfesor($id,$cedula, $nombre, $apellido, $email, $telefono, $usuario, $clave );
